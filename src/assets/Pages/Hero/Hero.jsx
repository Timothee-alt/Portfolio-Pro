...
function Hero() {
    ...
    <>
        ...
        <div className='flex justify-start relative ml-5 mt-16 md:justify-center md:mr-60 md:mt-40 lg:justify-center lg:mr-96 lg:mt-40 xl:h-screen'>
            ...
            <div className=''>
                ...
                <div>
                    <p className='text-white text-sm xl:text-lg ml-3 '>Je suis un dévelopeur web Full-Stack, passionné par le design et les nouvelles technologies </p>
                    <div className='flex ml-4 md:ml-50 lg:ml-6  gap-5 mt-10 items-center'>
                    <button className="px-4 rounded-full py-2 font-medium bg-purple-600 text-white w-fit transition-all shadow-[3px_3px_0px_white] hover:shadow-none hover:translate-x-[3px] hover:translate-y-[3px]">Mon CV</button>
