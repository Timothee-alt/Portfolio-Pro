...
function Skills() {
    const handleDownload = (certifType) => {
        const files = {
            anssi: '/ANSSI.pdf',
            cnil: '/CNIL.pdf',
            synthese: '/Synthese_BTS.pdf'  // Ajoutez votre fichier de synthèse dans le dossier public
        };
        
        window.open(files[certifType], '_blank');
    };

    // Mettre à jour tous les boutons de téléchargement pour avoir le même style
        ...
        <div id="skills" className="min-h-screen mt-32 px-4 pb-16">
            ...
            <div className="max-w-6xl mx-auto mt-16">
                <div className="grid gap-6 md:grid-cols-2">
                    {/* Languages Section */}
                    <div className="glassmorph-cards p-6 rounded-2xl bg-gradient-to-br from-purple-900/50 to-transparent backdrop-blur-sm border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300 relative overflow-hidden">
